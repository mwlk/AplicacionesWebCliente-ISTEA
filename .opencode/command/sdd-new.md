---
description: Crear cambio OpenSpec (modo full: proposal, design, tasks, documentation, specs).
---
...
- `CHANGE_NAME` (o derivarlo en kebab-case desde `REQUIREMENT`)
- `REQUIREMENT` o `FEATURE_DESCRIPTION`

Si faltan, pedirlos antes de continuar.

---
description: Configurar contexto IA del proyecto SpecDD. Ejecutar una sola vez despues de copiar spec-ia-agentic-engineer.
---

# sdd-setup - Configurar contexto IA del proyecto

Usar cuando se quiera inicializar el contexto SpecDD del proyecto.
...
5. proximo comando: `/sdd-new` para crear el primer change
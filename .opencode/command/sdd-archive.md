---
description: Cerrar y archivar un change OpenSpec (validar, documentar, fusionar spec estable, mover a archive/).
---
...
```text
/sdd-archive CHANGE_NAME="<nombre-carpeta-en-changes>"
```
